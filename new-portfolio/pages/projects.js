    ...
    <div>
        ...
        <div className={projectStyles.main}>
          ...
          <div className={projectStyles.projectCard}>
            <h3>LEC</h3>
            <div className={projectStyles.cardBody}>
              <Image src={'/lec.png'} alt={'jea'} width={'500'} height={'250'} />
          ...
          <div className={projectStyles.projectCard}>
            ...
            <div className={projectStyles.cardBody}>
            <Image src={'/sigma.png'} alt={'jea'} width={'500'} height={'250'} />
          ...
          <div className={projectStyles.projectCard}>
            ...
            <div className={projectStyles.cardBody}>
              <Image src={'/create.gif'} alt={'jea'} width={'500'} height={'250'} />
          ...
          <div className={projectStyles.projectCard}>
            <h3>Theater Site</h3>
            <div className={projectStyles.cardBody}>
              <Image src={'/homepage.gif'} alt={'jea'} width={'500'} height={'250'} />
